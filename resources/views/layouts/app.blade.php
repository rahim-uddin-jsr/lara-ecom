...
<script>
    $(document).ready(function () {
        $(document).on('click', '#addBook', function (e) {
            ...
            let data = {title, description, pages, price}
                    ...
                    if (errors) {
                        $.each(errors, function (field, messages) {
                            $.each(messages, function (i, message) {
                                $('.errorMassage').append('<span class="text-danger">' + message + '</span><br>');
                            });
                        });
                    }
                }
    ...
    $(document).on('click', '#updateBook', function (e) {
        ...
        let data = {id, title, description, pages, price}
        console.log(data);
    ...
    $(document).on('keyup', '#searchInput', function (e) {
        ...
        $.ajax({
            ...
            method: 'GET',
            data: { key: key }, // Corrected data format
            success: function (res) {
                $('.table-data').html(res);
            }
        });
